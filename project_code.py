...
def attack_class():
  ...
  feature_cols = ['dbytes','sbytes','dsport','sttl']
  ...
  print(metrics.classification_report(y_validation, y_pred))
  micro_f1 = f1_score(y_validation, y_pred, average='micro')
  print("Micro F1 Score after feature selection:", micro_f1) 
